...
g++ helloworld.cpp -o helloworld -I/home/kurazu/apps/v8 -I/usr/local/include -L/home/kurazu/apps/v8/out/x64.release/lib.target -L/home/kurazu/apps/v8/out/x64.release/obj.target/tools/gyp -lv8 -licui18n -licuuc -lv8_libplatform -lrt -ldl -pthread -std=c++0x
