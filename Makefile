...
run: build
	cd /home/kurazu/workspace/bridge/build/lib.linux-x86_64-3.4 && LD_LIBRARY_PATH=.:/home/kurazu/apps/boost/lib/:/home/kurazu/apps/v8/out/x64.release/lib.target python3 -c "import runjs"
